...
pareto_point = [] # [converged?,traj,u,p,z,theta]
pareto_z_u = [] # populate pareto front
pareto_u_p = [] # populate pareto front
converged_t = [] # populate pareto front
converged_cone_angle = []  # populate pareto front
...
def compute_trajectories():
    ...
    target_x = 1 - mu_star
    target_y = 0
    target_z = np.linspace(max_target_z, 0, 20) # choose z : decision variable
    tf_mult = np.linspace(1.5, 0, 20) # choose period : decision variable
